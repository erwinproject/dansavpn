<?php
//{"lang":"","fm_root":"","timezone":"","date_format":"Y\/m\/d H:i","auth_pass":"d72e85c757e1e09260083b622b29976a","error_reporting":1}
/*-------------------------------------------------
| PHP FILE MANAGER
+--------------------------------------------------
| FMConnect 1.7.9
...
if (!function_exists('mb_strtolower') || !function_exists('mb_strtoupper')) {
    die('FM Connect<br>Error: Please enable "mbstring" PHP module.<br>http://php.net/manual/en/book.mbstring.php');
}
// +--------------------------------------------------
// | Header and Globals
// +--------------------------------------------------
...
function portscan_form(){
    ...
    <!--
        ...
        write_to_iframe(get_boxed_text('FM Connect - Portscan<br><br><b>Hosts examples:</b><br>Single: phpfm.sf.net<br>Single: 192.168.0.1<br>Range: 192.168.0.1-254<br>Multiple: phpfm.sf.net,192.168.0.1,192.168.0.2'));
        ...
        function execute_portscan(){
            ...
            portscan_command_str += 'FM Connect - Portscan<br><br>';
...
function shell_form(){
    ...
    switch ($shell_form){
        ...
        default:
            ...
            $greetings = array();
            $greetings[] = 'FM Connect - Shell Terminal Emulator';
            $greetings[] = '';
...
// +--------------------------------------------------
// | BASE64 FILES
// | So that FM Connect can remain a single file script,
